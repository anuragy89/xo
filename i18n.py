...
"en": {
    ...
    "welcome_group": (
        ...
        "┣ � <code>/wordsearch</code> — Word Search puzzle\n"
    ...
    "help": (
        ...
        "<b>� Word Search</b>\n"
        "<code>/wordsearch</code> — Start a word search puzzle\n"
        "<code>/hint</code> — Get a letter hint\n"
        "<code>/endws</code> — End current word search\n\n"
        "<b>�💰 Economy</b>\n"
...
"ar": {
    ...
    "welcome_group": (
        ...
        "┣ � <code>/wordsearch</code> — البحث عن الكلمات\n"
    ...
    "help": (
        ...
        "<b>🔍 البحث عن الكلمات</b>\n"
        "<code>/wordsearch</code> — ابدأ لغز البحث عن الكلمات\n"
        "<code>/hint</code> — احصل على تلميح\n"
        "<code>/endws</code> — إنهاء اللعبة\n\n"
        "<b>💰 الاقتصاد</b>\n"
        "<code>/coins</code> — رصيدك\n"
...
"hi": {
    ...
    "welcome_group": (
        ...
        "┣ � <code>/wordsearch</code> — शब्द खोज पहेली\n"
    ...
    "help": (
        ...
        "<b>🔍 शब्द खोज</b>\n"
        "<code>/wordsearch</code> — शब्द खोज पहेली शुरू करें\n"
        "<code>/hint</code> — संकेत प्राप्त करें\n"
        "<code>/endws</code> — खेल समाप्त करें\n\n"
        "<b>💰 इकॉनमी</b>\n"
        "<code>/coins</code> — आपका बैलेंस\n"
